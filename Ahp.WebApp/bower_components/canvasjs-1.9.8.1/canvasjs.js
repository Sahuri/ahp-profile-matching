/*
 CanvasJS HTML5 & JavaScript Charts - v1.9.8.1 GA - https://canvasjs.com/ 
...
(function () {
    ...
    function ra(a, c, b) {
        if (u && Na) {
            ...
            a.width = c * Q;
            a.height = b * Q;
            za !== sa && (a.style.width = c + "px", a.style.height = b + "px", d.scale(Q, Q))
    ...
    function A(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.x2 = this.width;
            this.y2 = this.height;
            this._selectedColorSet = "undefined" !== typeof fa[this.colorSet] ? fa[this.colorSet] : fa.colorSet1;
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ia(this.ctx), u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ea(d, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
    ...
    function Z(a, c, b, d) {
        Z.base.constructor.call(this, "DataSeries", c, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
    ...
    function la(a) {
        ...
        this.ghostCanvas =
         ea(this.chart.width, this.chart.height);
    ...
    var y = {},
         ...
         for (r = h = z = e = l = 0; 0 < m.length;)
             if (c = m.pop(), "#" === c || "0" === c)
                 if (l++, l === n) {
                     ...
                     for (; 0 < v.length;) b = v.pop() + b, r++, 0 === r % h && (z === q && 0 < v.length) && (b = g + b)
                 } else 0 < k.length ? (b = k.pop() + b, e++, r++) : "0" === c && (b = "0" + b, e++, r++), 0 === r % h && (z === q && 0 < k.length) && (b = g + b);
             else "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (z++, h = r, r = 0, 0 < k.length &&
     ...
     sa = 1,
     Q = Na ? za / sa : 1,
     apps = -1 !== window.location.href.indexOf("localhost:8889") || -1 !== window.location.href.indexOf("localhost/lampapp") || -1 !== window.location.href.indexOf("10.90.1.90") || -1 !== window.location.href.indexOf("172.20.8.34") || -1 !== window.location.href.indexOf("PTMPGEAPPNET02.pertamina.com"),
     Aa = window && window.location && window.location.href &&
     window.location.href.indexOf && (-1 !== window.location.href.indexOf("canvasjs.com") || apps || -1 !== window.location.href.indexOf("fenopix.com") || -1 !== window.location.href.indexOf("fiddle")),
     Sa = {
         reset: {
    ...
    (function () {
        ...
        delete aa[y.fSDec([178,
         215, 208, 225, 227
        ])][y.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])];
        y.pro = {
            sCH: aa[y.fSDec([178, 215, 208, 225, 227])][y.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])]
        };
        y.fAWm = function (a) {
            if ("undefined" === typeof y.pro.sCH && !Aa) {
                var c = a[y.fSDec(y.str.ct)];
                c[y.fSDec(y.str.tBl)] = y.fSDec(y.str.tp);
                c[y.fSDec(y.str.fnt)] = 11 + y.fSDec(y.str.fntStr);
                c[y.fSDec(y.str.fSy)] = y.fSDec(y.str.gr);
                c[y.fSDec(y.str.fTx)](y.fSDec(y.str.tv), 2, a.height - 11 - 2)
            }
        }
    })();
    (function () {
        ...
        y.str.ckn = [206, 206, 210, 230, 217, 198, 226, 195, 225];
        y.str.tem = [195, 225, 216, 208, 219, 143, 191, 212, 225, 216, 222, 211, 143, 215, 208, 226, 143, 180, 231, 223, 216, 225, 212, 211, 144];
        y.str.ctm = [191, 219, 212, 208, 226, 212, 143, 210, 222, 221, 227, 208, 210, 227, 143, 226, 208, 219, 212, 226, 175, 210, 208, 221, 229, 208, 226, 217, 226, 157, 210, 222, 220];
        y.str.ltm = [213, 222, 225, 143, 219, 216, 210, 212, 221, 226, 212, 143, 222, 225, 143, 227, 225, 216, 208, 219, 143, 212, 231, 227, 212, 221, 227, 216, 222, 221];
        y.str.ckve = [212, 231, 223, 216,
         225, 212, 226, 172
        ];
        y.str.mco = [225, 214, 209, 208, 151, 161, 164, 164, 155, 161, 164, 164, 155, 161, 164, 164, 155, 159, 157, 164, 152];
        y.str.mcw = [198, 215, 216, 227, 212];
        y.str.mct = [225, 214, 209, 208, 151, 161, 162, 160, 155, 161, 168, 155, 164, 163, 155, 159, 157, 166, 152];
        y.str.mcr = [193, 212, 211];
        y.str.sk = [226, 212, 225, 216, 208, 219, 186, 212, 232];
        y.fNg = function (a) {
            if (!Aa) try {
                var c;
                a: {
                    var b = RegExp(y.ckDec(y.str.ckn) + "=.*", "gi"),
                     d = new Date,
                     f = document.cookie.match(b),
                     g = localStorage && localStorage.getItem("lclStg") && JSON.parse(localStorage.getItem("lclStg")).name.match(y.ckDec(y.str.ckn)) ?
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        var p = Math.round(Math.abs(g - d.getTime())),
                         n;
                        if (!x(ja[y.ckDec(y.str.sk)]) && "string" === typeof ja[y.ckDec(y.str.sk)] && ja[y.ckDec(y.str.sk)]) {
                            var e = ja[y.ckDec(y.str.sk)],
                             d = [];
                            k = [];
                        ...
                        h.setTime(l + 31536E6);
                        var s = {
                            name: y.ckDec(y.str.ckn),
                            val: (new Date).getTime()
                        };
                        document.cookie = y.ckDec(y.str.ckn) + "=" + (new Date).getTime() + "; " + y.ckDec(y.str.ckve) + h.toUTCString() + "; path=/;";
                ...
                if (c) {
                    c = 20;
                    var z = a.plotArea.ctx;
                    z.font = "bold " + c + (u ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    var v = y.ckDec(y.str.tem),
                     t = z.measureText(v).width;
                    z.fillStyle = u ? y.ckDec(y.str.mco) : y.ckDec(y.str.mcw);
                    z.fillRect(a.plotArea.x2 - t - 8, a.plotArea.y2 - 2.5 * c - 8, t + 4, 2.5 * c +
                     8);
                    z.fillStyle = u ? y.ckDec(y.str.mct) : y.ckDec(y.str.mcr);
                    z.textBaseline = "top";
                    z.fillText(v, a.plotArea.x2 - t - 4, a.plotArea.y2 - 2.5 * c - 2);
                    c = 14;
                    z.font = c + (u ? "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif" : "px Lucida Sans Unicode");
                    v = y.ckDec(y.str.ctm);
                    t = z.measureText(v).width;
                    z.fillStyle = u ? y.ckDec(y.str.mct) : y.ckDec(y.str.mcr);
                    z.fillText(v, a.plotArea.x2 - t - 4, a.plotArea.y2 - 2 * c - 4);
                    v = y.ckDec(y.str.ltm);
                    t = z.measureText(v).width;
                    z.fillText(v, a.plotArea.x2 - t - 4, a.plotArea.y2 - c - 4)
                }
            } catch (w) { }
        }
    })();
    L.prototype.setOptions = function (a, c) {
        if (aa[this._defaultsKey]) {
            var b = aa[this._defaultsKey],
             d;
            for (d in b) "publicProperties" !== d && b.hasOwnProperty(d) && (this[d] = a && d in a ? a[d] : c && d in c ? c[d] : b[d])
        }
    };
    L.prototype.get = function (a) {
        var c = aa[this._defaultsKey];
    ...
    L.prototype.updateOption = function (a) {
        var c = aa[this._defaultsKey],
         ...
         d = {},
         f = this[a];
        b && (ga[b] && ga[b][this._defaultsKey]) && (d = ga[b][this._defaultsKey]);
        a in c && (f =
    ...
    A.prototype._updateOptions = function () {
        ...
        this.updateOption("colorSet") && (this._selectedColorSet = "undefined" !== typeof fa[this.colorSet] ? fa[this.colorSet] : fa.colorSet1);
        ...
        this.options.zoomEnabled ? (this._zoomButton || (X(this._zoomButton = document.createElement("button")), S(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), J(this._zoomButton, "click", function () {
            a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, S(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, S(a, a._zoomButton,
             "pan"));
            a.render()
        })), this._resetButton || (X(this._resetButton = document.createElement("button")), S(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), J(this._resetButton, "click", function () {
            a.toolTip.hide();
            a.zoomEnabled || a.panEnabled ? (a.zoomEnabled = !0, a.panEnabled = !1, S(a, a._zoomButton, "pan"), a._defaultCursor = "default", a.overlaidCanvas.style.cursor = a._defaultCursor) : (a.zoomEnabled = !1, a.panEnabled = !1);
            ...
            X(a._zoomButton, a._resetButton);
        ...
        this._menuButton ? this.exportEnabled ? ta(this._menuButton) : X(this._menuButton) : this.exportEnabled && u && (this._menuButton = document.createElement("button"), S(this, this._menuButton, "menu"), this._toolBar.appendChild(this._menuButton), J(this._menuButton, "click", function () {
        ...
        "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? S(a, a._zoomButton, "zoom") : S(a, a._zoomButton, "pan"), a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && S(a, a._resetButton, "reset"));
    ...
    A.prototype._updateSize = function () {
        ...
        return this.canvas.width !== a * Q || this.canvas.height !== c *
         Q ? (ra(this.canvas, a, c), ra(this.overlaidCanvas, a, c), ra(this._eventManager.ghostCanvas, a, c), !0) : !1
    };
    A.prototype._initialize = function () {
        ...
        this.layoutManager = new ha(0, 0, this.width, this.height, 2);
        ...
        if (this.options.data)
            for (var c = 0; c < this.options.data.length; c++)
                if (a++, !this.options.data[c].type ||
                 0 <= A._supportedChartTypes.indexOf(this.options.data[c].type)) {
                    var b = new Z(this, this.options.data[c], a - 1, ++this._eventManager.lastObjectId);
        ...
        this.addEventListener("dataAnimationIterationEnd",
         function () {
             y.fAWm && y.fAWm(g);
             0 !== g.axisX.length && y.fNg && y.fNg(g)
         });
        Ra(this);
    ...
    A.prototype.render = function (a) {
        ...
        b ? ta(this._zoomButton, this._resetButton) : (X(this._zoomButton, this._resetButton), this.options.zoomEnabled && (this.zoomEnabled = !0, this.panEnabled = !1));
        this._processData();
        ...
        if (this.animatedRender) {
            var f = ea(this.width, this.height);
        ...
        for (a = 0; a < this.plotInfo.plotTypes.length; a++)
            for (var c = this.plotInfo.plotTypes[a], g = 0; g < c.plotUnits.length; g++) {
                ...
                k.targetCanvas =
                 null;
                this.animatedRender && (k.targetCanvas = ea(this.width, this.height), k.targetCanvasCtx = k.targetCanvas.getContext("2d"));
        ...
        this.animatedRender && 0 < this._indexLabels.length && (a = ea(this.width, this.height).getContext("2d"), d.push(this.renderIndexLabels(a)));
        var l = this;
        0 < d.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function (a) {
            l.ctx.clearRect(0, 0, l.width, l.height);
            l.ctx.drawImage(f, 0, 0, Math.floor(l.width * Q), Math.floor(l.height * Q), 0, 0, l.width, l.height);
            ...
            for (var c =
              a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = [], h = [], l = Infinity, m = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var n = this.data[a.dataSeriesIndexes[p]],
                 ...
                 r = !1,
                 s;
                if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var z = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                ...
                for (e = 0; e < n.dataPoints.length; e++) {
                    ...
                    f = x(n.dataPoints[e].y) ? 0 : n.dataPoints[e].y;
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
                    if (0 < e) {
                        if (a.axisX.logarithmic) {
                            var t = d / n.dataPoints[e - 1].x;
                            1 > t && (t = 1 / t);
                            b.minDiff > t && 1 !== t && (b.minDiff = t)
                        } else t = d - n.dataPoints[e - 1].x, 0 > t && (t *= -1), b.minDiff > t && 0 !== t && (b.minDiff = t);
                        null !== f && null !== n.dataPoints[e - 1].y && (a.axisY.logarithmic ? 0 < f && (t = f / n.dataPoints[e - 1].y, 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t)) : (t = f - n.dataPoints[e - 1].y, 0 > t && (t *= -1), c.minDiff >
                         t && 0 !== t && (c.minDiff = t)))
                    }
                    if (d < z && !q) null !== n.dataPoints[e].y && (s = d);
                    else {
                        if (!q && (q = !0, 0 < e)) {
                            e -= 2;
                            continue
    ...
    A.prototype._processStacked100PlotUnit =
     function (a) {
         if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
             for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, k = !1, h = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                 ...
                 for (n = 0; n < p.dataPoints.length; n++) {
                     ...
                     if (0 < n) {
                         ...
                         x(f) || null === p.dataPoints[n - 1].y || (a.axisY.logarithmic ? 0 < f && (v = f / p.dataPoints[n - 1].y, 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff =
                          v)) : (v = f - p.dataPoints[n - 1].y, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)))
                     }
                     if (d < s && !e) null !== f && (r = d);
                     else {
                         if (!e && (e = !0, 0 < n)) {
             ...
             a.axisY.logarithmic ? (c.max = x(c.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(c.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && !h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? 1 : Math.min(c.viewPortMin, 1)) : k && h ? (c.max = x(c.viewPortMax) ? 99 : Math.max(c.viewPortMax, 99), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99)) : !k && h && (c.max = x(c.viewPortMax) ? -1 : Math.max(c.viewPortMax, -1), c.min = x(c.viewPortMin) ? -99 : Math.min(c.viewPortMin, -99));
             c.viewPortMin = c.min;
             c.viewPortMax = c.max;
             a.dataPointYSums = l
         }
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g, k, h = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                var m = this.data[a.dataSeriesIndexes[l]],
                 ...
                 e = !1,
                 q, r, s;
                if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var z = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum :
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if ((f = m.dataPoints[p].y) && f.length) {
                        ...
                        r = !0;
                        for (var t = 0; t < f.length; t++) null === f.k && (r = !1);
                        r && (n || (s = q), q = d)
                    }
                    d < b.min && (b.min = d);
                    d > b.max && (b.max = d);
            ...
            if (!(b && 1 < b.length)) {
                ...
                try {
                    var g = f.y - this._lastTouchData.y,
                     k = f.time - this._lastTouchData.time;
                    if (15 < Math.abs(g) && (this._lastTouchData.scroll || 200 > k)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1;
                    ...
                    for (b = 0; b < c.length; b++) f = c[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, !1, !1, !1, !1, 0, null), d.target.dispatchEvent(g), a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault()
            }
        }
    };
    A.prototype._dispatchRangeEvent = function (a, c) {
        ...
        for (var f = 0; f < d.length; f++)
            if (x(b[d[f]]) && (b[d[f]] = []), "axisY" === d[f])
                ...
                for (g =
                 0; g < this.axisY2.length; g++) b[d[f]].push({
                     viewportMinimum: this[d[f]][g].sessionVariables.newViewportMinimum,
                     viewportMaximum: this[d[f]][g].sessionVariables.newViewportMaximum
                 });
            else if ("axisX" === d[f])
    ...
    A.prototype._mouseEventHandler = function (a) {
        ...
        A.capturedEventParam && (d = A.capturedEventParam, "mouseup" === b && (A.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup",
                ...
                if (!A.capturedEventParam && this._events) {
                    for (var g = 0; g < this._events.length; g++)
                        if (this._events[g].hasOwnProperty(b))
                            if (d =
                             this._events[g], f = d.bounds, c.x >= f.x1 && c.x <= f.x2 && c.y >= f.y1 && c.y <= f.y2) {
    ...
    A.prototype._plotAreaMouseUp = function (a, c) {
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)
                    for (f = g = 0; f < this._axes.length; f++) b = this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum * g, b.sessionVariables.newViewportMaximum = b.viewportMaximum *
                ...
                k && (this._ignoreNextEvent = !0, this._dispatchRangeEvent("rangeChanging", "zoom"), this.render(), this._dispatchRangeEvent("rangeChanged", "zoom"), k && (this.zoomEnabled && "none" ===
                 this._zoomButton.style.display) && (ta(this._zoomButton, this._resetButton), S(this, this._zoomButton, "pan"), S(this, this._resetButton, "reset")))
            }
        }
        this.isDrag = !1
    };
    A.prototype._plotAreaMouseMove = function (a, c) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            2 < Math.abs(b) && 8 > Math.abs(b) && (this.panEnabled ||
             this.zoomEnabled) ? this.toolTip.hide() : this.panEnabled || this.zoomEnabled || this.toolTip.mouseMoveHandler(a, c);
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(d)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) f = {
                    ...
                    return function () {
                        k._zoomPanToSelectedRegion(b, d, e, f, !0) &&
                         (k._dispatchRangeEvent("rangeChanging", "pan"), k.render(), k._dispatchRangeEvent("rangeChanged", "pan"), k.dragStartPoint.x = a, k.dragStartPoint.y = c)
                    }
                    ...
                    var d = f ? this.dragStartPoint.x : this.plotArea.x1,
                     ...
                     m = g ? c - this.dragStartPoint.y : this.plotArea.y2 -
                     this.plotArea.y1;
                    this.validateRegion(d, h, f ? a : this.plotArea.x2 - this.plotArea.x1, g ? c : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(), this.overlaidCanvasCtx.fillStyle = "#99B2B5");
    ...
    A.prototype.preparePlotArea = function () {
        ...
        u || (a.canvas.width = a.width, a.canvas.height = a.height, a.canvas.style.left = a.x1 + "px", a.canvas.style.top =
         a.y1 + "px", (0 < a.x1 || 0 < a.y1) && a.ctx.translate(-a.x1, -a.y1));
        a.layoutManager = new ha(a.x1, a.y1, a.x2, a.y2, 2)
    };
    A.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            var k = K("indexLabelFontWeight", m.dataPoint, m.dataSeries),
             ...
             d = 0 < z ? Math.min(10, ("normal" === this.plotInfo.axisPlacement ? this.plotArea.height : this.plotArea.width) << 0) : 0,
             v = {
                 percent: null,
                 total: null
             },
            ...
            if (m.dataSeries.indexLabelFormatter || m.dataPoint.indexLabelFormatter) t = {
                chart: this,
            ...
            var w = m.dataPoint.indexLabelFormatter ?
             m.dataPoint.indexLabelFormatter(t) : m.dataPoint.indexLabel ? this.replaceKeywordsWithValue(m.dataPoint.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : m.dataSeries.indexLabelFormatter ? m.dataSeries.indexLabelFormatter(t) : m.dataSeries.indexLabel ? this.replaceKeywordsWithValue(m.dataSeries.indexLabel, m.dataPoint, m.dataSeries, null, m.indexKeyword) : null;
            if (null !== w && "" !== w) {
                var v = K("indexLabelPlacement", m.dataPoint, m.dataSeries),
                 t = K("indexLabelOrientation", m.dataPoint, m.dataSeries),
                 ia = m.direction,
                ...
                if (0 <= p.indexOf("stackedarea100")) {
                    if (m.point.x < b.x1 || m.point.x > b.x2 || m.point.y < b.y1 - 1 || m.point.y > b.y2 + 1) continue
                } else if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") ||
                 0 <= p.indexOf("bubble") || 0 <= p.indexOf("scatter")) {
                    if (m.dataPoint.x < Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum || m.dataPoint.y < B.viewportMinimum || m.dataPoint.y > B.viewportMaximum) continue
                 ...
                 Y.viewportMinimum || m.dataPoint.x > Y.viewportMaximum) continue;
                f = k = 2;
                "horizontal" === t ? (h = q.width, l = q.height) : (l = q.width, h = q.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    n = m.point.x - h / 2;
                    "inside" !== v ? (f = b.y1, g = b.y2, 0 < ia ? (e = m.point.y - l - k - d, e < f && (e = "auto" === v ? Math.max(m.point.y, f) + k + d : f + k + d, y = e + l > m.point.y)) : (e = m.point.y + k + d, e > g - l - k - d && (e =
                     ...
                     l))
                } else 0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? (v = "auto", f = 4) : 0 <= p.indexOf("stacked") ? "auto" === v && (v = "inside") : "bubble" === p && (v = "inside"), e = m.point.y - l / 2, "inside" !== v ? (k = b.x1, g = b.x2, 0 > ia ? (n = m.point.x - h - f - d, n < k && (n = "auto" === v ? Math.max(m.point.x, k) + f + d : k + f + d, y = n + h > m.point.x)) : (n = m.point.x + f + d, n > g - h - f - d && (n = "auto" === v ? Math.min(m.point.x, g) - h - f - d : g - h - f - d, y = n < m.point.x))) : (k = Math.max(m.bounds.x1, b.x1), Math.min(m.bounds.x2, b.x2), d = 0 <= p.indexOf("range") ? 0 > ia ? Math.max(m.bounds.x1,
                 b.x1) + h / 2 + f : Math.min(m.bounds.x2, b.x2) - h / 2 - f : (Math.max(m.bounds.x1, b.x1) + Math.min(m.bounds.x2, b.x2)) / 2, n = 0 > ia ? Math.max(m.point.x, d) - h / 2 : Math.min(m.point.x, d) - h / 2, n = Math.max(n, k));
                "vertical" === t && (e += l);
                q.x = n;
                q.y = e;
                q.render(!0);
                z && ("inside" !== v && (0 > p.indexOf("bar") && m.point.x > b.x1 && m.point.x < b.x2 || !y) && (0 > p.indexOf("column") && m.point.y > b.y1 && m.point.y < b.y2 || !y)) && (c.lineWidth = z, c.strokeStyle = s ? s : "gray", c.setLineDash && c.setLineDash(G(r, z)), c.beginPath(), c.moveTo(m.point.x, m.point.y), 0 <= p.indexOf("bar") ?
                 c.lineTo(n + (0 < m.direction ? 0 : h), e + ("horizontal" === t ? l : -l) / 2) : 0 <= p.indexOf("column") ? c.lineTo(n + h / 2, e + ((0 < m.direction ? l : -l) + ("horizontal" === t ? l : -l)) / 2) : c.lineTo(n + h / 2, e + ((e < m.point.y ? l : -l) + ("horizontal" === t ? l : -l)) / 2), c.stroke())
            }
        }
        c = {
            source: c,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var h = k.dataPoints,
                 l = "solid";
                if (c.setLineDash) {
                    var m = G(k.nullDataLineDashType, k.lineThickness),
                     l = k.lineDashType,
                     p = G(l, k.lineThickness);
                    c.setLineDash(p)
                }
                var n = k.id;
                ...
                var n = k._colorSet,
                 e = n = k.lineColor = k.options.lineColor ? k.options.lineColor : n[0];
                c.strokeStyle = n;
                var q = !0,
                 r = 0,
                 s, z;
                c.beginPath();
                if (0 < h.length) {
                    for (var v = !1, r = 0; r < h.length; r++)
                        if (s = h[r].x.getTime ? h[r].x.getTime() : h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                          !v)))
                            if ("number" !== typeof h[r].y) 0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0;
                            else {
                                s = a.axisX.convertValueToPixel(s);
                                z = a.axisY.convertValueToPixel(h[r].y);
                                ...
                                q || v ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || l === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), l = k.nullDataLineDashType, c.setLineDash(m)), c.lineTo(s,
                                 z), u && b.lineTo(s, z)) : (c.beginPath(), c.moveTo(s, z), u && (b.beginPath(), b.moveTo(s, z))), v = q = !1) : (c.lineTo(s, z), u && b.lineTo(s, z), 0 == r % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, z), u && (b.stroke(), b.beginPath(), b.moveTo(s, z))));
                                r < h.length - 1 && (e !== (h[r].lineColor || n) || l !== (h[r].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(s, z), e = h[r].lineColor || n, c.strokeStyle = e, c.setLineDash && (h[r].lineDashType ? (l = h[r].lineDashType, c.setLineDash(G(l, k.lineThickness))) : (l = k.lineDashType, c.setLineDash(p))));
                                if (0 < h[r].markerSize || 0 < k.markerSize) {
                                    var w = k.getMarkerProperties(r, s, z, c);
                                    d.push(w);
                                    t = E(t);
                                    u && d.push({
                                        x: s,
    ...
    A.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < h.length) {
                    for (var v = !1, r = 0; r < h.length; r++)
                        if (s = h[r].getTime ? h[r].x.getTime() :
                         h[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !v)))
                            if ("number" !== typeof h[r].y) 0 < r && !(k.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0;
                            else {
                                var t = z;
                                s = a.axisX.convertValueToPixel(s);
                                z = a.axisY.convertValueToPixel(h[r].y);
                                var w = k.dataPointIds[r];
                                ...
                                q || v ? (!q && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || l === k.lineDashType &&
                                 k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), l = k.nullDataLineDashType, c.setLineDash(m)), c.lineTo(s, t), c.lineTo(s, z), u && (b.lineTo(s, t), b.lineTo(s, z))) : (c.beginPath(), c.moveTo(s, z), u && (b.beginPath(), b.moveTo(s, z))), v = q = !1) : (c.lineTo(s, t), u && b.lineTo(s, t), c.lineTo(s, z), u && b.lineTo(s, z), 0 == r % 500 && (c.stroke(), c.beginPath(), c.moveTo(s, z), u && (b.stroke(), b.beginPath(), b.moveTo(s, z))));
                                r < h.length - 1 && (e !== (h[r].lineColor || n) || l !== (h[r].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(s,
                                 z), e = h[r].lineColor || n, c.strokeStyle = e, c.setLineDash && (h[r].lineDashType ? (l = h[r].lineDashType, c.setLineDash(G(l, k.lineThickness))) : (l = k.lineDashType, c.setLineDash(p))));
                                if (0 < h[r].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(r, s, z, c), d.push(t), w = E(w), u && d.push({
                                    x: s,
                                    y: z,
                                    ctx: b,
                                    type: t.type,
        ...
        function c(a) {
            ...
            if (0 < a.length) {
                ...
                a[0].newLineDashArray &&
                 b.setLineDash(a[0].newLineDashArray);
                u && d.moveTo(a[0].x, a[0].y);
                for (var c = 0; c < a.length - 3; c += 3)
                    if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), u && d.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), u && (d.stroke(), d.beginPath(),
                     d.moveTo(a[c + 3].x, a[c + 3].y));
                b.stroke();
                u && d.stroke()
            }
        }
            ...
            for (var f = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length)
                    for (z = !1, r = 0; r < l.length; r++)
                        if (s = l[r].getTime ? l[r].x.getTime() : l[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !z)))
                            if ("number" !==
                             typeof l[r].y) 0 < r && !z && (h.connectNullData ? b.setLineDash && (0 < v.length && (h.options.nullDataLineDashType || !l[r - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = p, m = h.nullDataLineDashType) : (c(v), v = [])), z = !0;
                            else {
                                s = a.axisX.convertValueToPixel(s);
                                z = a.axisY.convertValueToPixel(l[r].y);
                                var t = h.dataPointIds[r];
                                this._eventManager.objectMap[t] = {
                                    id: t,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: k,
                                ...
                                r < l.length - 1 && (q !== (l[r].lineColor || e) || m !== (l[r].lineDashType || h.lineDashType)) &&
                                 (q = l[r].lineColor || e, v[v.length - 1].newStrokeStyle = q, b.setLineDash && (l[r].lineDashType ? (m = l[r].lineDashType, v[v.length - 1].newLineDashArray = G(m, h.lineThickness)) : (m = h.lineDashType, v[v.length - 1].newLineDashArray = n)));
                                if (0 < l[r].markerSize || 0 < h.markerSize) {
                                    var w = h.getMarkerProperties(r, s, z, b);
                                    f.push(w);
                                    t = E(t);
                                    u && f.push({
                                        x: s,
    ...
    var M = function (a, c, b, d, f, g, k, h, l, m, p, n, e) {
        ...
        a.fillRect(c,
         b, d - c, f - b);
        a.globalAlpha = 1;
        0 < k && (e = 0 === k % 2 ? 0 : 0.5, a.beginPath(), a.lineWidth = k, a.strokeStyle = h, a.moveTo(c, b), a.rect(c - e, b - e, d - c + 2 * e, f - b + 2 * e), a.stroke());
        a.restore();
                ...
                if (0 < e.length)
                    for (var q = 5 < p && n.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, g, k, r, s, b, 0, null, !1, !1, !1, !1);
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                             z = d - a.plotType.plotUnits.length * n /
                             2 + a.index * n << 0,
                             v = z + n << 0,
                             t;
                            if (a.axisY.logarithmic) k[b] = r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (l = a.axisY.convertValueToPixel(k[b]), t = f[b] ? f[b] : m, f[b] = l);
                            ...
                            M(c, z, l, v, t, b, 0, null, s && 0 <= r[h].y, 0 > r[h].y && s, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, z, l, v, t, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null,
             d = this.plotArea,
             f = 0,
             g, k, h, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
             ...
             p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            p = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(p) / Math.log(a.axisX.range) : Math.abs(p) / Math.abs(a.axisX.range)) /
             a.plotType.totalDataSeries) << 0;
            this.dataPointMaxWidth && f > m && (f = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, m));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && m < f) && (m = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, f));
            p < f && (p = f);
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            k = a.axisX.reversed ? k + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + d) * p << 0 : k - a.plotType.totalDataSeries *
                             p / 2 + (a.previousDataSeriesCount + d) * p << 0;
                            ...
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, s, k, g, r, b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b =
             ...
             n = a.axisX.dataInfo.minDiff;
            isFinite(n) || (n = 0.3 * Math.abs(a.axisX.range));
            n = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.height * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) :
             Math.abs(n) / Math.abs(a.axisX.range)) / a.plotType.plotUnits.length) << 0;
            this.dataPointMaxWidth && h > p && (h = Math.min(this.dataPointWidth ? this.dataPointWidth : Infinity, p));
            !this.dataPointMaxWidth && (this.dataPointMinWidth && p < h) && (p = Math.max(this.dataPointWidth ? this.dataPointWidth : -Infinity, h));
            n < h && (n = h);
            n > p && (n = p);
            ...
            c.rect(d.x1, d.y1, d.width, d.height);
            c.clip();
            u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width,
             d.height), this._eventManager.ghostCtx.clip());
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                var e = a.dataSeriesIndexes[p],
                 q = this.data[e],
                 r = q.dataPoints;
                    ...
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                             ...
                             v = z + n << 0,
                             t;
                            if (a.axisY.logarithmic) k[b] =
                             r[h].y + (k[b] ? k[b] : 0), 0 < k[b] && (t = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(k[b]));
                            else if (l = a.axisY.convertValueToPixel(r[h].y), 0 <= r[h].y) {
                                var w = f[b] ? f[b] : 0;
                                t = m + w;
                                l += w;
                                f[b] = w + (l - t)
                            } else w = g[b] ? g[b] : 0, t = l - w, l = m - w, g[b] = w + (l - t);
                            b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                            M(c, t, z, l, v, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                ...
                if (0 < r.length) {
                    ...
                    c.strokeStyle = "#4572A7 ";
                    for (h = 0; h < r.length; h++)
                        if (b = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" ===
                         typeof r[h].y) {
                            var d = a.axisX.convertValueToPixel(b),
                             z;
                            z = 0 !== a.dataPointYSums[b] ? 100 * (r[h].y / a.dataPointYSums[b]) : 0;
                            ...
                            } else if (l = a.axisY.convertValueToPixel(z), 0 <= r[h].y) {
                                var w = f[b] ? f[b] : 0;
                                z = m + w;
                                l += w;
                                f[b] = w + (l - z)
                            ...
                            b = r[h].color ? r[h].color : q._colorSet[h % q._colorSet.length];
                            M(c, z, v,
                             l, t, b, 0, null, s, !1, !1, !1, q.fillOpacity);
                            b = q.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
                                objectType: "dataPoint",
                            ...
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, z, v, l, t, b, 0, null, !1, !1, !1, !1);
                            (r[h].indexLabel || q.indexLabel || r[h].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderArea = function (a) {
        function c() {
            t && (0 < m.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? v = z : 0 > a.axisY.viewportMaximum ? v = g.y1 : 0 < a.axisY.viewportMinimum && (v = f.y2), b.lineTo(q, v),
             b.lineTo(t.x, v), b.closePath(), b.globalAlpha = m.fillOpacity, b.fill(), b.globalAlpha = 1, u && (d.lineTo(q, v), d.lineTo(t.x, v), d.closePath(), d.fill()), b.beginPath(), b.moveTo(q, r), d.beginPath(), d.moveTo(q, r), t = {
                 x: q,
                 y: r
             })
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            b.clip();
            u && (d.beginPath(), d.rect(h.x1,
             h.y1, h.width, h.height), d.clip());
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < p.length) {
                    var w = m._colorSet[e % m._colorSet.length],
                     x = m.lineColor = m.options.lineColor || w,
                     y = x;
                    b.fillStyle = w;
                    b.strokeStyle = x;
                    ...
                    if (b.setLineDash) {
                        var A = G(m.nullDataLineDashType, m.lineThickness),
                         B = m.lineDashType,
                         C = G(B, m.lineThickness);
                        b.setLineDash(C)
                    }
                    for (var N = !0; e < p.length; e++)
                        if (s = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !N)))
                            if ("number" !== typeof p[e].y) m.connectNullData || (N || n) || c(), N = !0;
                            else {
                                q = a.axisX.convertValueToPixel(s);
                                r = a.axisY.convertValueToPixel(p[e].y);
                                n || N ? (!n && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType ||
                                 B === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), B = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, r), u && d.lineTo(q, r)) : (b.beginPath(), b.moveTo(q, r), u && (d.beginPath(), d.moveTo(q, r)), t = {
                                     x: q,
                                     y: r
                                 }), N = n = !1) : (b.lineTo(q, r), u && d.lineTo(q, r), 0 == e % 250 && c());
                                e < p.length - 1 && (y !== (p[e].lineColor || x) || B !== (p[e].lineDashType || m.lineDashType)) && (c(), y = p[e].lineColor || x, b.strokeStyle = y, b.setLineDash && (p[e].lineDashType ? (B = p[e].lineDashType, b.setLineDash(G(B, m.lineThickness))) : (B = m.lineDashType,
                                 b.setLineDash(C))));
                                ...
                                0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize) && (s = m.getMarkerProperties(e, q, r, b), k.push(s), H = E(H), u && k.push({
                                    x: q,
                                    y: r,
                                    ctx: d,
                                    type: s.type,
    ...
    A.prototype.renderSplineArea = function (a) {
        function c() {
            ...
            if (0 < c.length) {
                ...
                b.fill();
                b.globalAlpha = 1;
                u && (d.lineTo(c[c.length -
                 1].x, s), d.lineTo(z.x, s), d.closePath(), d.fill())
            }
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < p.length) {
                    var t = m._colorSet[n % m._colorSet.length],
                     w = m.lineColor = m.options.lineColor || t,
                     x = w;
                    b.fillStyle = t;
                    b.strokeStyle = w;
                    b.lineWidth = m.lineThickness;
                    var y = "solid";
                    if (b.setLineDash) {
                        var B = G(m.nullDataLineDashType, m.lineThickness),
                         y = m.lineDashType,
                         A = G(y, m.lineThickness);
                        b.setLineDash(A)
                    }
                    for (q = !1; n < p.length; n++)
                        if (e = p[n].x.getTime ?
                         p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
                            if ("number" !== typeof p[n].y) 0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = B, y = m.nullDataLineDashType) : (c(), v = [])), q = !0;
                            else {
                                ...
                                n < p.length - 1 && (x !== (p[n].lineColor || w) || y !== (p[n].lineDashType || m.lineDashType)) && (x = p[n].lineColor || w, v[v.length - 1].newStrokeStyle = x, b.setLineDash && (p[n].lineDashType ? (y = p[n].lineDashType, v[v.length - 1].newLineDashArray = G(y, m.lineThickness)) : (y = m.lineDashType, v[v.length - 1].newLineDashArray = A)));
         ...
         if (!(0 >= a.dataSeriesIndexes.length)) {
             ...
             for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                 ...
                 var k = [],
                  n = !0,
                  e = 0,
                  q, r, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                   a.axisY.viewportMinimum : 0),
                  v, t = null,
                  w = !1;
                 if (0 < p.length) {
                     var x = m._colorSet[e % m._colorSet.length],
                      y = m.lineColor = m.options.lineColor || x,
                      B = y;
                     b.fillStyle = x;
                     b.strokeStyle = y;
                     b.lineWidth = m.lineThickness;
                     var A = "solid";
                     if (b.setLineDash) {
                         var C = G(m.nullDataLineDashType, m.lineThickness),
                          A = m.lineDashType,
                          N = G(A, m.lineThickness);
                         b.setLineDash(N)
                     }
                     for (; e < p.length; e++)
                         if (s = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !w))) {
                             var H = r;
                             "number" !==
                             typeof p[e].y ? (m.connectNullData || (w || n) || c(), w = !0) : (q = a.axisX.convertValueToPixel(s), r = a.axisY.convertValueToPixel(p[e].y), n || w ? (!n && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || A === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), A = m.nullDataLineDashType, b.setLineDash(C)), b.lineTo(q, H), b.lineTo(q, r), u && (d.lineTo(q, H), d.lineTo(q, r))) : (b.beginPath(), b.moveTo(q, r), u && (d.beginPath(), d.moveTo(q, r)), t = {
                                 x: q,
                                 y: r
                             }), w = n = !1) : (b.lineTo(q, H), u && d.lineTo(q, H), b.lineTo(q,
                              r), u && d.lineTo(q, r), 0 == e % 250 && c()), e < p.length - 1 && (B !== (p[e].lineColor || y) || A !== (p[e].lineDashType || m.lineDashType)) && (c(), B = p[e].lineColor || y, b.strokeStyle = B, b.setLineDash && (p[e].lineDashType ? (A = p[e].lineDashType, b.setLineDash(G(A, m.lineThickness))) : (A = m.lineDashType, b.setLineDash(N)))), H = m.dataPointIds[e], this._eventManager.objectMap[H] = {
                                  id: H,
                                  objectType: "dataPoint",
                                  dataSeriesIndex: l,
                                  dataPointIndex: e,
                                  x1: q,
                                  y1: r
                              }, 0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize) && (s = m.getMarkerProperties(e, q,
                              r, b), k.push(s), H = E(H), u && k.push({
                                  x: q,
                                  y: r,
                                  ctx: d,
                                  type: s.type,
    ...
    A.prototype.renderStackedArea = function (a) {
        function c() {
            if (!(1 > h.length)) {
                for (0 < t.lineThickness && b.stroke() ; 0 < h.length;) {
                    var a = h.pop();
                    b.lineTo(a.x, a.y);
                    u && s.lineTo(a.x, a.y)
                }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null,
             ...
             m = [],
             p = 0,
             n, e, q, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
              a.axisY.viewportMinimum : 0),
            ...
            for (var z = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    var d = t._colorSet[0],
                     x = t.lineColor = t.options.lineColor || d,
                     y = x;
                    b.fillStyle = d;
                    b.strokeStyle = x;
                    ...
                    var B = "solid";
                    if (b.setLineDash) {
                        var A = G(t.nullDataLineDashType, t.lineThickness),
                         B = t.lineDashType,
                         C = G(B, t.lineThickness);
                        b.setLineDash(C)
                    }
                    for (var N = !0, p = 0; p < l.length; p++) {
                        q = l[p];
                        var H = null,
                         H = 0 <= t.dataPointIndexes[q] ?
                         w[t.dataPointIndexes[q]] : {
                             x: q,
                             y: null
                         };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
                            if ("number" !== typeof H.y) t.connectNullData || (N || z) || c(), N = !0;
                                ...
                                } else e = a.axisY.convertValueToPixel(H.y), e -= ca;
                                h.push({
                                    x: n,
                                    y: r - ca
                                });
                                k[q] = r - e;
                                z || N ? (!z && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType ||
                                 B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(A)), b.lineTo(n, e), u && s.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), u && (s.beginPath(), s.moveTo(n, e))), N = z = !1) : (b.lineTo(n, e), u && s.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), u && s.moveTo(n, e), h.push({
                                     x: n,
                                     y: r - ca
                                 })));
                                p < w.length - 1 && (y !== (w[p].lineColor || x) || B !== (w[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e), h.push({
                                    x: n,
                                    y: r - ca
                                }), y = w[p].lineColor || x, b.strokeStyle = y, b.setLineDash &&
                                 (w[p].lineDashType ? (B = w[p].lineDashType, b.setLineDash(G(B, t.lineThickness))) : (B = t.lineDashType, b.setLineDash(C))));
                                if (0 <= t.dataPointIndexes[q]) {
                                    var da = t.dataPointIds[t.dataPointIndexes[q]];
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(t.dataPointIndexes[q], n, e, b), f.push(q), markerColor = E(da), u && f.push({
                                    x: n,
                                    y: e,
                                    ctx: s,
                                    type: q.type,
                    ...
                    for (var N = !0, p = 0; p < l.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
                            if ("number" !== typeof H.y) t.connectNullData || (N || z) || c(), N = !0;
                                ...
                                var ca;
                                ca = 0 !== a.dataPointYSums[q] ? 100 * (H.y / a.dataPointYSums[q]) : 0;
                                n = a.axisX.convertValueToPixel(q);
                                var da = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) {
                                    m[q] = ca + (m[q] ? m[q] : 0);
                                    if (0 >= m[q]) continue;
                                    e = a.axisY.convertValueToPixel(m[q])
                                } else e = a.axisY.convertValueToPixel(ca), e -= da;
                                h.push({
                                    x: n,
                                    y: r - da
                                });
                                k[q] = r - e;
                                z || N ? (!z &&
                                 t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(A)), b.lineTo(n, e), u && s.lineTo(n, e)) : (b.beginPath(), b.moveTo(n, e), u && (s.beginPath(), s.moveTo(n, e))), N = z = !1) : (b.lineTo(n, e), u && s.lineTo(n, e), 0 == p % 250 && (c(), b.moveTo(n, e), u && s.moveTo(n, e), h.push({
                                     x: n,
                                     y: r - da
                                 })));
                                p < w.length - 1 && (y !== (w[p].lineColor || x) || B !== (w[p].lineDashType || t.lineDashType)) && (c(), b.beginPath(), b.moveTo(n, e),
                                 h.push({
                                     x: n,
                                     y: r - da
                                 }), y = w[p].lineColor || x, b.strokeStyle = y, b.setLineDash && (w[p].lineDashType ? (B = w[p].lineDashType, b.setLineDash(G(B, t.lineThickness))) : (B = t.lineDashType, b.setLineDash(C))));
                                if (0 <= t.dataPointIndexes[q]) {
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(p, n, e, b),
                                 g.push(q), markerColor = E(Fa), u && g.push({
                                     x: n,
                                     y: e,
                                     ctx: s,
                                     type: q.type,
    ...
    A.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = -Infinity, h = Infinity,
              l = 0; l < a.dataSeriesIndexes.length; l++)
                for (var m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, e = 0, d = 0; d < n.length; d++) f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[d].z || (e = n[d].z, e > k && (k = e), e < h && (h = e));
                    ...
                    for (c.strokeStyle =
                     "#4572A7 ", d = 0; d < n.length; d++)
                        if (f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[d].y) {
                            ...
                            r = E(s);
                            u && P.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, r, r, e.borderThickness);
                ...
                if (0 < m.length) {
                    ...
                    for (var p = 0, n = 0, d = 0; d < m.length; d++)
                        if (f = m[d].getTime ? f = m[d].x.getTime() : f = m[d].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[d].y) {
                            ...
                            P.drawMarker(e.x,
                             e.y, e.ctx, e.type, e.size, e.color, e.borderColor, e.borderThickness);
                            c.globalAlpha = 1;
                            Math.sqrt((p - f) * (p - f) + (n - g) * (n - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (p = l.dataPointIds[d], this._eventManager.objectMap[p] = {
                                ...
                                x1: f,
                                y1: g
                            }, p = E(p), u && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, p, p, e.borderThickness), (m[d].indexLabel || l.indexLabel || m[d].indexLabelFormatter || l.indexLabelFormatter) &&
                             this._indexLabels.push({
                                 chartType: "scatter",
                                 dataPoint: m[d],
                                 dataSeries: l,
    ...
    A.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d =
             ...
             d = this.plotArea,
             f = 0,
             g, k, h, l, m, p, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            this.dataPointMaxWidth && f > g && (f = Math.min(this.dataPointWidth ?
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)
                    for (var z = 5 < n && r.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ?
                         p = s[f].x.getTime() : p = s[f].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                            ...
                            "candlestick" === r.type ? (c.moveTo(g - x, h), c.lineTo(g - x, Math.min(k, m)), c.stroke(), c.moveTo(g - x, Math.max(k, m)), c.lineTo(g - x, l), c.stroke(), M(c, v, Math.min(k, m), t, Math.max(k, m), s[f].y[0] <= s[f].y[3] ? r.risingColor :
                             ...
                             k), b.stroke(), b.beginPath(), b.moveTo(g, m), b.lineTo(t, m), b.stroke()));
    ...
    A.prototype.renderRangeColumn =
     function (a) {
         ...
         if (!(0 >= a.dataSeriesIndexes.length)) {
             ...
             h = this.dataPointWidth ? this.dataPointWidth : 0.9 * (d.width * (a.axisX.logarithmic ? Math.log(h) / Math.log(a.axisX.range) :
              Math.abs(h) / Math.abs(a.axisX.range)) / a.plotType.totalDataSeries) << 0;
                 ...
                 if (0 < n.length)
                     for (var e = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < n.length; f++)
                         if (n[f].getTime ? k = n[f].x.getTime() : k = n[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
                             ...
                             var q = a.axisX.reversed ? b + a.plotType.totalDataSeries * h / 2 - (a.previousDataSeriesCount + l) * h << 0 : b - a.plotType.totalDataSeries * h / 2 + (a.previousDataSeriesCount + l) * h << 0,
                             ...
                             b = E(s);
                             u && M(this._eventManager.ghostCtx, q, d, r, g,
                              b, 0, null, !1, !1, !1, !1);
    ...
    A.prototype.renderRangeBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            g = this.dataPointMaxWidth ?
             this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0;
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                var p = a.dataSeriesIndexes[m],
                 ...
                 e = n.dataPoints;
                if (0 < e.length) {
                    var q = 5 < l && n.bevelEnabled ?
                     !0 : !1;
                    c.strokeStyle = "#4572A7 ";
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ? h = e[f].x.getTime() : h = e[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            d = a.axisY.convertValueToPixel(e[f].y[0]);
                            g = a.axisY.convertValueToPixel(e[f].y[1]);
                            k = a.axisX.convertValueToPixel(h);
                            k = a.axisX.reversed ? k + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + m) * l << 0 : k - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount +
                             m) * l << 0;
                            ...
                            b = E(b);
                            u && M(this._eventManager.ghostCtx, d, k, g, r, b, 0, null, !1, !1, !1, !1);
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < m.length) {
                    var v = l._colorSet[n % l._colorSet.length],
                     t = l.lineColor = l.options.lineColor || v,
                     w = t;
                    b.fillStyle = v;
                    b.strokeStyle = t;
                    ...
                    if (b.setLineDash) {
                        var y = G(l.nullDataLineDashType, l.lineThickness),
                         x = l.lineDashType,
                         B = G(x, l.lineThickness);
                        b.setLineDash(B)
                    }
                    for (var A = !0; n < m.length; n++)
                        if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData ||
                          !A)))
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                p || A ? (l.connectNullData && !p ? (b.setLineDash && (l.options.nullDataLineDashType || x === l.lineDashType && l.lineDashType !== l.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = B, x = l.nullDataLineDashType, b.setLineDash(y)), b.lineTo(e, q), u && d.lineTo(e, q), k.push({
                                    x: e,
                                    y: r
                                 ...
                                 q), z = {
                                     ...
                                     x: e,
                                     y: r
                                 }), u && (d.beginPath(), d.moveTo(e, q))), A = p = !1) : (b.lineTo(e, q), k.push({
                                     x: e,
                                     y: r
                                ...
                                n < m.length - 1 && (w !== (m[n].lineColor || t) || x !== (m[n].lineDashType || l.lineDashType)) && (c(), w = m[n].lineColor || t, k[k.length - 1].newStrokeStyle = w, b.strokeStyle = w, b.setLineDash && (m[n].lineDashType ? (x = m[n].lineDashType, k[k.length - 1].newLineDashArray =
                                 G(x, l.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (x = l.lineDashType, k[k.length - 1].newLineDashArray = B, b.setLineDash(B))));
                                ...
                                if (m[n].indexLabel ||
                                 l.indexLabel || m[n].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({
                                     chartType: "rangeArea",
                                     dataPoint: m[n],
                                     dataSeries: l,
                                     indexKeyword: 0,
            ...
            if (0 < e.length) {
                if (0 < h.lineThickness) {
                    ...
                    for (var f = 0; f < e.length - 3; f += 3) {
                        if (e[f].newStrokeStyle || e[f].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), e[f].newStrokeStyle && (b.strokeStyle = e[f].newStrokeStyle), e[f].newLineDashArray &&
                ...
                for (f = e.length - 1; 2 < f; f -= 3) b.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y,
                 e[f - 3].x, e[f - 3].y), u && d.bezierCurveTo(e[f - 1].x, e[f - 1].y, e[f - 2].x, e[f - 2].y, e[f - 3].x, e[f - 3].y);
                b.closePath();
                ...
                if (0 < h.lineThickness) {
                    ...
                    for (var g = f = 0; f < e.length - 3; f += 3, g++) {
                        if (q[g].newStrokeStyle || q[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle), q[g].newLineDashArray &&
                         b.setLineDash(q[g].newLineDashArray);
                        b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y)
                    }
                    b.stroke()
                }
            ...
            for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (0 < l.length) {
                    var s = h._colorSet[m % h._colorSet.length],
                     z = h.lineColor = h.options.lineColor || s,
                     v = z;
                    b.fillStyle = s;
                    b.lineWidth = h.lineThickness;
                    var t = "solid",
                    ...
                    if (b.setLineDash) {
                        var x = G(h.nullDataLineDashType, h.lineThickness),
                         t = h.lineDashType;
                        w = G(t, h.lineThickness)
                    }
                    for (n = !1; m < l.length; m++)
                        if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax &&
                          (!h.connectNullData || !n)))
                            if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] && "number" === typeof l[m].y[1]) {
                                ...
                                m < l.length - 1 && (v !== (l[m].lineColor || z) || t !== (l[m].lineDashType || h.lineDashType)) && (v = l[m].lineColor ||
                                 z, q[q.length - 1].newStrokeStyle = v, b.setLineDash && (l[m].lineDashType ? (t = l[m].lineDashType, q[q.length - 1].newLineDashArray = G(t, h.lineThickness)) : (t = h.lineDashType, q[q.length - 1].newLineDashArray = w)));
                                if (0 !== l[m].markerSize && (0 < l[m].markerSize || 0 < h.markerSize)) {
                                    var B = h.getMarkerProperties(m, p, n, b);
                                    f.push(B);
                                    var A = E(y);
                                    u && f.push({
                                        x: p,
                                    ...
                                    B = h.getMarkerProperties(m, p, e, b);
                                    f.push(B);
                                    A = E(y);
                                    u && f.push({
                                        x: p,
                                ...
                                if (l[m].indexLabel || h.indexLabel || l[m].indexLabelFormatter || h.indexLabelFormatter) this._indexLabels.push({
                                    chartType: "splineArea",
                                    dataPoint: l[m],
                                    dataSeries: h,
                                    indexKeyword: 0,
                                ...
                                n = !1
                            } else 0 < m && !n && (h.connectNullData ? b.setLineDash &&
                             (0 < q.length && (h.options.nullDataLineDashType || !l[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = x, t = h.nullDataLineDashType) : (c(w, z), q = [], r = [])), n = !0;
                    c(w, z);
                    P.drawMarkers(f)
                }
            }
    ...
    var Ga = function (a, c, b, d, f, g, k, h, l) {
        if (!(0 > b)) {
            ...
            if (!u) {
                ...
                Number((g % (2 * Math.PI)).toFixed(8)) ===
                 m && (k -= 1E-4)
            }
            a.save();
            a.globalAlpha = h;
            "pie" === f ? (a.beginPath(), a.moveTo(c.x, c.y), a.arc(c.x, c.y, b, g, k, !1), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === f && (a.beginPath(), a.arc(c.x, c.y, b, g, k, !1), 0 <= l && a.arc(c.x, c.y, l * b, k, g, !0), a.closePath(), a.fillStyle = d, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
            a.globalAlpha = 1;
            a.restore()
        }
    };
    A.prototype.renderPie = function (a) {
        function c() {
            if (m && p) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < p.length; f++) {
                    ...
                    h.indexLabelLineColor = g.indexLabelLineColor ? g.indexLabelLineColor : m.options.indexLabelLineColor ? m.options.indexLabelLineColor : g.color ? g.color : m._colorSet[f % m._colorSet.length];
                    h.indexLabelLineThickness = x(g.indexLabelLineThickness) ? m.indexLabelLineThickness : g.indexLabelLineThickness;
                    h.indexLabelLineDashType = g.indexLabelLineDashType ? g.indexLabelLineDashType :
                     m.indexLabelLineDashType;
                    h.indexLabelFontColor = g.indexLabelFontColor ? g.indexLabelFontColor : m.indexLabelFontColor;
                    h.indexLabelFontStyle = g.indexLabelFontStyle ? g.indexLabelFontStyle : m.indexLabelFontStyle;
                    h.indexLabelFontWeight = g.indexLabelFontWeight ? g.indexLabelFontWeight : m.indexLabelFontWeight;
                    h.indexLabelFontSize = x(g.indexLabelFontSize) ? m.indexLabelFontSize : g.indexLabelFontSize;
                    ...
                    h.indexLabelBackgroundColor = g.indexLabelBackgroundColor ?
                     g.indexLabelBackgroundColor : m.options.indexLabelBackgroundColor ? m.options.indexLabelBackgroundColor : m.indexLabelBackgroundColor;
                    h.indexLabelMaxWidth = g.indexLabelMaxWidth ? g.indexLabelMaxWidth : m.indexLabelMaxWidth ? m.indexLabelMaxWidth : 0.33 * e.width;
                ...
                n = !1;
                for (f = 0; f < p.length; f++) h = q[(d + f) % p.length], 1 < b && (h.midAngle >
                 3 * Math.PI / 2 - v && h.midAngle < 3 * Math.PI / 2 + v) && (k <= b / 2 && !n ? (h.hemisphere = "left", k++) : (h.hemisphere = "right", n = !0))
            }
        }
        ...
        function b(a) {
            ...
            for (b = 0; b < p.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * B * Math.cos(q[b].midAngle),
                     ...
                     h = !1;
                    if (p[b].exploded) {
                        if (1E-9 < Math.abs(q[b].center.x - (w.x + f)) || 1E-9 < Math.abs(q[b].center.y - (w.y + g))) q[b].center.x =
                         w.x + f * a, q[b].center.y = w.y + g * a, h = !0
                    } else if (0 < Math.abs(q[b].center.x - w.x) || 0 < Math.abs(q[b].center.y - w.y)) q[b].center.x = w.x + f * (1 - a), q[b].center.y = w.y + g * (1 - a), h = !0;
            ...
            for (b = b = 0; b < p.length; b++) c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== m.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== m.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness &&
             (d = c.center.x + B * Math.cos(c.midAngle), f = c.center.y + B * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(G(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, f), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
            a.save()
        }
        ...
        function f(a) {
            for (var b = null, c = 1; c < p.length; c++)
                if (b = (a + c + q.length) % q.length, q[b].hemisphere !== q[a].hemisphere) {
                    b = null;
                    break
                } else if (q[b].indexLabelText && b !== a && (0 > d(q[b], q[a]) || ("right" === q[a].hemisphere ? q[b].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y : q[b].indexLabelTextBlock.y <=
                 q[a].indexLabelTextBlock.y))) break;
                else b = null;
            return b
        }
        ...
        function g(a, b, c) {
            ...
            if (0 <= a && a < p.length) {
                ...
                var m = 0,
                 n = 0,
                 n = m = m = 0;
                0 > b ? l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 > h && l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b < h && (b = -(h - (l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 + b))) : l.indexLabelTextBlock.y + l.indexLabelTextBlock.height /
                 2 < h && l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b > k && (b = l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2 + b - k);
                ...
                for (k = 1; k < p.length; k++)
                    if (h =
                     (a - k + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
                        h = null;
                        break
                ...
                m = f(a);
                k = h = 0;
                0 > b ? (k = "right" === l.hemisphere ? n : m, e = b, null !== k && (n = -b, b = l.indexLabelTextBlock.y - l.indexLabelTextBlock.height / 2 - (q[k].indexLabelTextBlock.y + q[k].indexLabelTextBlock.height /
                 2), b - n < r && (h = -n, k = g(k, h, c + 1), +k.toFixed(t) > +h.toFixed(t) && (e = b > r ? -(b - r) : -(n - (k - h)))))) : 0 < b && (k = "right" === l.hemisphere ? m : n, e = b, null !== k && (n = b, b = q[k].indexLabelTextBlock.y - q[k].indexLabelTextBlock.height / 2 - (l.indexLabelTextBlock.y + l.indexLabelTextBlock.height / 2), b - n < r && (h = n, k = g(k, h, c + 1), +k.toFixed(t) < +h.toFixed(t) && (e = b > r ? b - r : n - (h - k)))));
                e && (c = l.indexLabelTextBlock.y + e, b = 0, b = "right" === l.hemisphere ? w.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)) : w.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - w.y, 2)), l.midAngle >
                 Math.PI / 2 - v && l.midAngle < Math.PI / 2 + v ? (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "left" === l.hemisphere && "right" === h.hemisphere && b > h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x - 15 : "right" === l.hemisphere && ("left" === a.hemisphere && b < a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x + 15)) : l.midAngle > 3 * Math.PI / 2 - v && l.midAngle < 3 * Math.PI / 2 + v && (h = (a - 1 + q.length) % q.length, h = q[h], a = q[(a + 1 + q.length) % q.length], "right" === l.hemisphere && "left" === h.hemisphere && b < h.indexLabelTextBlock.x ? b = h.indexLabelTextBlock.x +
                  15 : "left" === l.hemisphere && ("right" === a.hemisphere && b > a.indexLabelTextBlock.x) && (b = a.indexLabelTextBlock.x - 15)), l.indexLabelTextBlock.y = c, l.indexLabelTextBlock.x = b, l.indexLabelAngle = Math.atan2(l.indexLabelTextBlock.y - w.y, l.indexLabelTextBlock.x - w.x))
            }
            return e
        }
        ...
        function k() {
            ...
            for (var b = a = 0, c = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < c) ; b++) {
                    ...
                    for (var v, u, a = 0; a < p.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            var y = 0,
                             y = d(v, u) - r;
                            if (0 > y) {
                                for (var A = u = 0, E = 0; E < p.length; E++) E !== a && q[E].hemisphere === k.hemisphere && (q[E].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? u++ :
                                 A++);
                                u = y / (u + A || 1) * A;
                                var A = -1 * (y - u),
                                 D = E = 0;
                                "right" === k.hemisphere ? (E = g(a, u), A = -1 * (y - E), D = g(x, A), +D.toFixed(t) < +A.toFixed(t) && +E.toFixed(t) <= +u.toFixed(t) && g(a, -(A - D))) : (E = g(x, u), A = -1 * (y - E), D = g(a, A), +D.toFixed(t) < +A.toFixed(t) && +E.toFixed(t) <= +u.toFixed(t) && g(x, -(A - D)))
                            }
                        }
                    }
                } else
                ...
                for (a = 0; a < p.length; a++)
                    if (k = q[a], x = k.indexLabelTextBlock.measureText(),
                     ...
                     w.x) < B && (x /= Math.abs(Math.sin(k.indexLabelAngle)), 9 < x && (x *= 0.3), x > c && (c = x)));
                            ...
                            if (null !== k) {
                                ...
                                if (l = 0 > y) {
                                    ...
                                    var m = v.indexLabelTextBlock.y - v.indexLabelTextBlock.height / 2,
                                     ...
                                     u = h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2;
                                    l = v.indexLabelTextBlock.x + v.indexLabelTextBlock.width < h.indexLabelTextBlock.x - n || l > t + n || m > u + n || r < s - n ? !1 : !0
                                }
                                l ? (0 > a && (a = g), k !== a && (b = k, c += -y), 0 === g % Math.max(p.length /
                                 10, 3) && (e = !0)) : e = !0;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var m = this.data[a.dataSeriesIndexes[0]],
             ...
             u = 0;
            a = !1;
            for (var A = 0; A < p.length; A++) u += Math.abs(p[A].y), !a && ("undefined" !== typeof p[A].indexLabel && null !== p[A].indexLabel && 0 < p[A].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof p[A].label && null !== p[A].label && 0 < p[A].label.toString().length) &&
             (a = !0);
            if (0 !== u) {
                ...
                m.radius && (B = Oa(m.radius, B));
                var C = "undefined" !== typeof m.innerRadius && null !== m.innerRadius ? Oa(m.innerRadius, B) : 0.7 * B;
                m.radius = B;
                "doughnut" === m.type && (m.innerRadius = C);
                var F = Math.min(C / B, (B - 1) / B);
                this.pieDoughnutClickHandler = function (a) {
                    l.isAnimating || !x(a.dataSeries.explodeOnClick) &&
    ...
    ha.prototype.registerSpace = function (a, c) {
    ...
    ha.prototype.unRegisterSpace = function (a, c) {
    ...
    ha.prototype.getFreeSpace = function () {
        return {
    ...
    wa.prototype.render = function () {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
         ...
         g = 0,
         k = 0,
         h = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ?
        ...
        for (var p = 0; p < this.dataSeries.length; p++) {
            ...
            if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type) {
                var e = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? Z.getDefaultLegendMarker(n.type) : n.markerType,
                ...
                for (var t = 0; t < n.dataPoints.length; t++) {
                    var w = n.dataPoints[t],
                     e = w.legendMarkerType ? w.legendMarkerType : n.legendMarkerType ? n.legendMarkerType : Z.getDefaultLegendMarker(n.type),
                     ...
                     v = w.legendMarkerBorderThickness ? w.legendMarkerBorderThickness : n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness : w.markerBorderThickness ||
        ...
        if (0 < l.length) {
            n = null;
            r = t = q = w = 0;
            q = null !== this.itemWidth ? null !== this.itemMaxWidth ? Math.min(this.itemWidth, this.itemMaxWidth, g) : this.itemMaxWidth =
             Math.min(this.itemWidth, g) : null !== this.itemMaxWidth ? Math.min(this.itemMaxWidth, g) : this.itemMaxWidth = g;
            ...
            for (p = 0; p < l.length; p++) {
                ...
                if (!(0 >= k || "undefined" === typeof k || 0 >= q || "undefined" === typeof q)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!n || n.width + Math.round(e.textBlock.width + s + h + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 *
                        ...
                        fontStyle: this.fontStyle,
                        textBaseline: "middle"
                    }), e.textBlock.measureText(), null !== this.itemWidth && (e.textBlock.width = this.itemWidth - (s + h + ("line" === e.chartType ||
                     "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < k - this.lineHeight ? (n = {
                         items: [],
                         width: 0
                    ...
                    r = e.textBlock.width + (s + h + ("line" ===
                     e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))
                }
            }
            this.itemWidth = r;
            this.height = !1 === this.itemWrap ? m.length * this.lineHeight : this.height + t;
            this.height = Math.min(k, this.height);
            this.width = Math.min(g, this.width)
        }
        "top" === this.verticalAlign ? (f = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2, d = c.y1) : "center" === this.verticalAlign ? (f = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width :
         c.x1 + c.width / 2 - this.width / 2, d = c.y1 + c.height / 2 - this.height / 2) : "bottom" === this.verticalAlign && (f = "left" === this.horizontalAlign ? c.x1 : "right" === this.horizontalAlign ? c.x2 - this.width : c.x1 + c.width / 2 - this.width / 2, d = c.y2 - this.height);
        this.items = l;
        ...
        for (p = c = 0; p < m.length; p++) {
            ...
            for (w = t = 0; w < n.items.length; w++) {
                ...
                this.ctx.clip();
                if ("line" === e.chartType ||
                 "stepLine" === e.chartType || "spline" === e.chartType) this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(r - 0.1 * this.lineHeight, u + this.lineHeight / 2), this.ctx.lineTo(r + 0.85 * this.lineHeight, u + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
                P.drawMarker(r + s / 2, u + this.lineHeight / 2, this.ctx, e.markerType, e.markerSize, e.markerColor, e.markerBorderColor, e.markerBorderThickness);
                e.textBlock.x = r + h + s;
    ...
    T(Z, L);
    Z.prototype.getDefaultAxisPlacement = function () {
        var a = this.type;
    ...
    Z.getDefaultLegendMarker = function (a) {
    ...
    Z.prototype.getDataPointAtX = function (a, c) {
    ...
    Z.prototype.getMarkerProperties = function (a, c, b, d) {
    ...
    C.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            }) : "axisX" === this.type && this.labels[a] ? this.labels[a] : Ea(b, this.valueFormatString, this.chart._cultureInfo), a = new V(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: g,
            ...
            if (this.logarithmic && !this.equidistantInterval) {
                ...
                for (var e = 0; e < this.logLabelValues.length; e++) b = this.logLabelValues[e], b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
                    ...
                    value: b,
                    label: this.labels[b] ? this.labels[b] : null
                }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ba(b, this.valueFormatString, this.chart._cultureInfo), a = new V(this.ctx, {
                    x: 0,
                    y: 0,
                    maxWidth: g,
                    maxHeight: k,
        ...
        if (this.labelAutoFit || this.options.labelAutoFit)
            if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle %
              360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                if (g = 0.9 * l >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)
                        if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math,
                          f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (k - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), x(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                            if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? k : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = (p - (m + a.fontSize / 2) *
                             ...
                             k, this.sessionVariables.labelWrap = this.labelWrap);
                                ...
                                if (x(this.options.labelWrap))
                                    if (!x(this.options.labelMaxWidth)) this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = k);
                                    else if (!x(c))
                                        if (d = q.width + c.width >> 0, e = this.labelFontSize, n < g) d - 2 * g > h && (h = d - 2 * g, d >= 2 * g && d < 2.2 * g ? (this.sessionVariables.labelMaxWidth =
                                         ...
                                         x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s) : d > 5 * g && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = g, this.sessionVariables.labelFontSize = e, this.sessionVariables.labelMaxHeight = k, this.sessionVariables.labelAngle = this.labelAngle));
                ...
                if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, k = "undefined" === typeof this.options.labelWrap || this.labelWrap ?
        ...
        for (b = 0; b < this.stripLines.length; b++) {
            ...
            if ("outside" === g.labelPlacement) {
                ...
                if ("bottom" === this._position || "top" === this._position) z = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                if ("left" === this._position || "right" === this._position) z = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                c = x(g.options.labelBackgroundColor) ? "#EEEEEE" :
                 g.options.labelBackgroundColor
            } else k = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, z = "undefined" === typeof g.options.labelWrap || g.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, c = x(g.options.labelBackgroundColor) ? x(g.startValue) && 0 !== g.startValue ? u ? "transparent" : null : "#EEEEEE" : g.options.labelBackgroundColor;
            a = new V(this.ctx, {
                x: 0,
                y: 0,
                backgroundColor: c,
    ...
    C.setLayoutAndRender = function (a, c, b, d, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > q;) {
                ...
                if (b &&
                 0 < b.length)
                    for (e = 0; e < b.length; e++) D = 10, b[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, h = Math.round(g.y1 + U + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 + U + K), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), D = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - W - f - D), b[e].lineCoordinates = {
                        ...
                        width: l - k,
                        height: m - h
                    }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), P += t[e] + b[e].margin);
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && (k = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), l = Math.round(k), D = d[e]._labels && 0 < d[e]._labels.length ? d[e]._labels[d[e]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(g.y1 + U + K < Math.max(D, 10) ? Math.max(D, 10) : g.y1 +
                     U + K), D = 0 < a.length ? 0 : d[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - (W + f + D)), d[e].lineCoordinates = {
                         x1: k + O,
                         y1: h,
                         x2: k + O,
                         y2: m,
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) a[e] && (a[e].calculateValueToPixelConversionParameters(), a[e]._labels &&
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) c[e].calculateValueToPixelConversionParameters(), c[e]._labels && 1 < c[e]._labels.length && (y = (c[e].logarithmic ? Math.log(c[e]._labels[1].position /
                      c[e].viewportMinimum) / c[e].conversionParameters.lnLogarithmBase : c[e]._labels[1].position - c[e].viewportMinimum) * Math.abs(c[e].conversionParameters.pixelPerUnit) + c[e].lineCoordinates.x1, A = "dateTime" === c[e].chart.plotInfo.axisXValueType ? (c[e].logarithmic ? Math.log(c[e]._labels[c[e]._labels.length - 2].position / c[e].viewportMinimum) / c[e].conversionParameters.lnLogarithmBase : c[e]._labels[c[e]._labels.length - 2].position - c[e].viewportMinimum) * Math.abs(c[e].conversionParameters.pixelPerUnit) + c[e].lineCoordinates.x1 :
                     (c[e].logarithmic ? Math.log(c[e]._labels[c[e]._labels.length - 1].position / c[e].viewportMinimum) / c[e].conversionParameters.lnLogarithmBase : c[e]._labels[c[e]._labels.length - 1].position - c[e].viewportMinimum) * Math.abs(c[e].conversionParameters.pixelPerUnit) + c[e].lineCoordinates.x1);
                if (b && 0 < b.length)
            ...
            if (a && 0 < a.length)
                for (e = 0; e <
                 a.length; e++) a[e].renderLabelsTicksAndTitle();
            if (c && 0 < c.length)
            ...
            L = [];
            if (a && 0 < a.length)
                for (e = 0; e < a.length; e++) a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 *
                 a[e].titleFontSize, a[e]._titleTextBlock.angle = -90);
            if (c && 0 < c.length)
            ...
            for (; 4 > q;) {
                ...
                L.push(r);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) b[e].lineCoordinates = {}, k = Math.round(g.x1 + W + f), l = Math.round(g.x2 - U - K > p.width - 10 ? p.width - 10 : g.x2 - U - K), b[e].labelAutoFit && !x(u) && (0 < !a.length && (k = 0 > b[e].labelAngle ? Math.max(k, u) : 0 === b[e].labelAngle ? Math.max(k, u / 2) : k), 0 < !c.length && (l = 0 < b[e].labelAngle ? l - v / 2 : 0 === b[e].labelAngle ?
                     l - v / 2 : l)), b[e].lineCoordinates.x1 = k, b[e].lineCoordinates.x2 = l, b[e].lineCoordinates.width = Math.abs(l - k), b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width);
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e].lineCoordinates = {}, k = Math.round(g.x1 + W + f), l = Math.round(g.x2 - U - K > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - U - K), d[e] && d[e].labelAutoFit && !x(t) && (0 < !a.length && (k = 0 < d[e].labelAngle ? Math.max(k, t) :
                     0 === d[e].labelAngle ? Math.max(k, t / 2) : k), 0 < !c.length && (l -= w / 2)), d[e].lineCoordinates.x1 = k, d[e].lineCoordinates.x2 = l, d[e].lineCoordinates.width = Math.abs(l - k), d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width);
                if (b && 0 < b.length)
                    for (y = [], e = O = 0; e < b.length; e++) y.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += y[e] + b[e].margin, D += b[e].margin;
                else y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() :
                 0));
                s.push(y);
                if (d && 0 < d.length)
                ...
                G.push(A);
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) 0 < b[e]._labels.length && (m = b[e]._labels[0], h = b[e]._labels[b[e]._labels.length - 1], u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)),
                     v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], h = d[e]._labels[d[e]._labels.length - 1], t = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) +
                     (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
                if (p.panEnabled)
                    for (e = 0; e < b.length; e++) y[e] = p.sessionVariables.axisY.height;
                else
                    for (e = 0; e < b.length; e++) p.sessionVariables.axisY.height = y[e];
                if (b && 0 < b.length)
                    for (e = b.length - 1; 0 <= e; e--) h = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = h - (y[e] + b[e].margin + M), b[e].lineCoordinates.y2 = h - (y[e] + b[e].margin + M), b[e].bounds = {
                        x1: k,
                        y1: h - (y[e] + M + b[e].margin),
                        x2: l,
                        y2: m - (M + b[e].margin),
                        width: l - k,
                        height: y[e]
                    }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width), M += y[e] + b[e].margin;
                if (d && 0 < d.length)
                    for (e = d.length - 1; 0 <= e; e--) d[e] && (h = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + Q)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
                        x1: k,
                        y1: h + (d[e].margin + Q),
                        x2: l,
                        y2: m,
                        width: l - k,
                        height: T
                    }, d[e].title && (d[e]._titleTextBlock.maxWidth = 0 <
                     d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width), Q += A[e] + d[e].margin);
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > p.height -
                         Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2 - O) : g.y2 > p.height - Math.max(D, 10) ? p.height - Math.max(D, 10) : g.y2;
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++) b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, u) : 0 === b[D].labelAngle ? Math.max(l, u / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - W : k);
                        if (d && 0 < d.length)
                            for (D = 0; D < d.length; D++) d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x1, k = l - W);
                        a[e].lineCoordinates = {
                            x1: l - J,
                            y1: h,
                            x2: l - J,
                ...
                if (c && 0 < c.length)
                    for (e = 0; e < c.length; e++) {
                        ...
                        k = Math.round(g.x1 - f);
                        h = d && 0 < d.length ? Math.round(d[0] ? d[0].lineCoordinates.y2 : g.y1 < Math.max(D, 10) ? Math.max(D, 10) : g.y1) : g.y1 < Math.max(D, 10) ? Math.max(D,
                         10) : g.y1;
                        l = Math.round(g.x2 - U - K);
                        ...
                        if (b && 0 < b.length)
                            for (D = 0; D < b.length; D++) b[D] && b[D].labelAutoFit && (l = 0 > b[D].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, k = 0 > b[D].labelAngle || 0 === b[D].labelAngle ? l - U : k);
                        if (d && 0 < d.length)
                            for (D = 0; D < d.length; D++) d[D] && d[D].labelAutoFit && (l = d[D].lineCoordinates.x2, k = l - U);
                        c[e].lineCoordinates = {
                            x1: l + P,
                            y1: h,
                            x2: l + P,
    ...
    C.prototype.renderLabelsTicksAndTitle = function () {
        ...
        if ("undefined" === typeof this.options.interval) {
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], d = 0 !== this.labelAngle &&
                      360 !== this.labelAngle ? 1 : 1.2, g, k = this.viewportMaximum, h = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        p = this._labels[l];
                        if (p.position < this.viewportMinimum) break;
                        p.position > this.viewportMaximum || !(l === this._labels.length - 1 || g < Math.log(k / p.position) * h / d) || (c.push(p), k = p.position, g = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                    }
                    this._labels = c
                } else {
                    for (l = 0; l < this._labels.length; l++) p =
                     this._labels[l], p.position < this.viewportMinimum || (p = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += p);
                    c > this.lineCoordinates.width * d && this.labelAutoFit && (a = !0)
                }
            if ("left" === this._position || "right" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var c = [], m, k = this.viewportMaximum, h = this.lineCoordinates.height / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) {
                        p = this._labels[l];
                        if (p.position < this.viewportMinimum) break;
                    ...
                    for (l = 0; l < this._labels.length; l++) p = this._labels[l], p.position < this.viewportMinimum || (p = p.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin(Math.PI /
                     180 * this.labelAngle)), b += p);
        ...
        if ("bottom" === this._position) {
            ...
            for (l = 0; l < this._labels.length; l++) p = this._labels[l], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle =
             ...
             180 * this.labelAngle) + (0 < this.labelAngle ? p.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0))), p.textBlock.x = b.x, p.textBlock.y = b.y, p.textBlock.render(!0)));
            ...
            for (l = 0; l < this._labels.length; l++) p = this._labels[l], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, d = 1 === this.ctx.lineWidth %
    ...
    C.prototype.renderInterlacedColors = function () {
        ...
        if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor,
             f = 0; f < this._labels.length; f++) c ? (c = this.getPixelCoordinatesOnAxis(this._labels[f].position), b = f + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position), a.fillRect(Math.min(b.x, c.x), d.y1, Math.abs(b.x - c.x), Math.abs(d.y1 - d.y2)), c = !1) : c = !0;
        else if (("left" === this._position || "right" === this._position) && this.interlacedColor)
            for (a.fillStyle = this.interlacedColor, f = 0; f < this._labels.length; f++) c ? (b = this.getPixelCoordinatesOnAxis(this._labels[f].position),
             c = f + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position), a.fillRect(d.x1, Math.min(b.y, c.y), Math.abs(d.x1 - d.x2), Math.abs(c.y - b.y)), c = !1) : c = !0;
        a.beginPath()
    };
        ...
        if (this.stripLines && 0 < this.stripLines.length && a) {
            for (var c = this, b, d = 0, f = 0, g = !1, k = !1, h = [], l = [], k = !1, d = 0; d < this.stripLines.length; d++) {
                ...
                m._thicknessType === a && ("pixel" === a && (m.value < this.viewportMinimum ||
                 m.value > this.viewportMaximum || x(m.value) || isNaN(this.range)) || h.push(m))
            }
            ...
            if (!k) {
                ...
                for (d = 0; d < h.length; d++) m = h[d], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
                    ...
                    this.ctx.clip();
                    for (f = 0; f < h.length; f++) m = h[f], m.showOnTop && m.render();
                    this.ctx.restore()
                }, m)) : m.render();
                for (d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ?
                 k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
            ...
            if (k)
                for (k = !1, d = 0; d < l.length; d++) b = l[d], b.stripLine.showOnTop ?
                 k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
    ...
    C.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            a.setLineDash && a.setLineDash(G(this.gridDashType,
             this.gridThickness));
            if ("bottom" === this._position || "top" === this._position)
    ...
    C.prototype.renderAxisLine = function () {
        ...
        } else "left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(G(this.lineDashType, this.lineThickness)), c = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 <<
    ...
    C.prototype.calculateAxisParameters =
     function () {
         if (this.logarithmic) this.calculateLogarithamicAxisParameters();
             ...
             var a = Math.max(d, Math.floor(this.maxWidth /
               a)),
              f, g, k, d = 0;
             ...
             if ("axisX" === this.type) {
              ...
              f = 0), 0 === f && 0 === g ? (g += 9, f = 0) : 0 === g - f ? (d = Math.min(Math.abs(0.01 * Math.abs(g)), 5), g += d, f -= d) : f > g ? (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 5), 0 <= g ? f = g - d : g = f + d) : (d = Math.min(Math.abs(0.01 * Math.abs(g - f)), 0.05), 0 !== g && (g += d), 0 !== f && (f -= d)), k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1, this.includeZero && (null === this.viewportMinimum || isNaN(this.viewportMinimum)) && 0 < f && (f = 0), this.includeZero && (null === this.viewportMaximum || isNaN(this.viewportMaximum)) && 0 > g && (g = 0));
             d = (isNaN(this.viewportMaximum) ||
             ...
             if ("axisX" === this.type && b) {
                 this.intervalType || (d / 1 <= a ? (this.interval = 1, this.intervalType = "millisecond") : d / 2 <= a ? (this.interval = 2, this.intervalType = "millisecond") : d / 5 <= a ? (this.interval = 5, this.intervalType = "millisecond") : d / 10 <= a ? (this.interval = 10, this.intervalType = "millisecond") : d / 20 <= a ? (this.interval = 20, this.intervalType = "millisecond") : d / 50 <= a ? (this.interval = 50, this.intervalType =
                  ...
                  d / (3 * I.hourDuration) <= a ? (this.interval = 3, this.intervalType = "hour") : d / (6 * I.hourDuration) <= a ? (this.interval = 6, this.intervalType = "hour") : d / (1 * I.dayDuration) <= a ? (this.interval = 1, this.intervalType = "day") : d / (2 * I.dayDuration) <= a ? (this.interval = 2, this.intervalType = "day") : d / (4 * I.dayDuration) <= a ? (this.interval = 4, this.intervalType = "day") : d / (1 * I.weekDuration) <= a ? (this.interval = 1, this.intervalType = "week") : d / (2 * I.weekDuration) <= a ? (this.interval = 2, this.intervalType = "week") : d / (3 * I.weekDuration) <= a ? (this.interval =
                   3, this.intervalType = "week") : d / (1 * I.monthDuration) <= a ? (this.interval = 1, this.intervalType = "month") : d / (2 * I.monthDuration) <= a ? (this.interval = 2, this.intervalType = "month") : d / (3 * I.monthDuration) <= a ? (this.interval = 3, this.intervalType = "month") : d / (6 * I.monthDuration) <= a ? (this.interval = 6, this.intervalType = "month") : (this.interval = d / (1 * I.yearDuration) <= a ? 1 : d / (2 * I.yearDuration) <= a ? 2 : d / (4 * I.yearDuration) <= a ? 4 : Math.floor(C.getNiceNumber(d / (a - 1), !0) / I.yearDuration), this.intervalType = "year"));
                 if (null === this.viewportMinimum ||
                  isNaN(this.viewportMinimum)) this.viewportMinimum = f - k / 2;
                 ...
                 if (null === this.viewportMinimum || isNaN(this.viewportMinimum)) this.viewportMinimum =
                  "axisX" === this.type ? f - k / 2 : Math.floor(f / this.interval) * this.interval;
                 ...
                 0 === this.viewportMaximum && 0 === this.viewportMinimum && (0 === this.options.viewportMinimum ? this.viewportMaximum += 10 : 0 === this.options.viewportMaximum && (this.viewportMinimum -= 10), this.options && "undefined" === typeof this.options.interval && (this.interval = C.getNiceNumber((this.viewportMaximum - this.viewportMinimum) /
                  (a - 1), !0)))
             }
             if (null === this.minimum || null === this.maximum)
                 ...
                 } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? f - k / 2 : Math.floor(f / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
    ...
    C.prototype.getLabelStartPoint = function () {
        var a = I[this.intervalType + "Duration"] * this.interval,
    ...
    A.prototype.replaceKeywordsWithValue = function (a, c, b, d, f) {
        ...
        if ((0 <= b.type.indexOf("stacked") || "pie" === b.type || "doughnut" === b.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            ...
            do {
                ...
                a = a.replace("#percent", ba(k, l, g._cultureInfo));
                a = a.replace("#total", ba(h, b.yValueFormatString ? b.yValueFormatString : "#,##0.########", g._cultureInfo))
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            if ("x" === a)
                ...
                } else return ba(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo);
            else return "y" === a ? ba(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########",
             g._cultureInfo) : "z" === a ? ba(h, c.zValueFormatString ? c.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
        })
    };
    ...
    var F = {
     ...
     ja = {
         ...
         formatNumber: function (a, c, b) {
             b = b || "en";
             if (pa[b]) return ba(a, c || "#,##0.##", new oa(b));
