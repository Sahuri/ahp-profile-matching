...
8|a[2]:0}function K(a,c,b){return a in c?c[a]:b[a]}function ra(a,c,b){if(u&&Na){var d=a.getContext("2d");sa=d.webkitBackingStorePixelRatio||d.mozBackingStorePixelRatio||d.msBackingStorePixelRatio||d.oBackingStorePixelRatio||d.backingStorePixelRatio||1;Q=za/sa;a.width=c*Q;a.height=b*Q;za!==sa&&(a.style.width=c+"px",a.style.height=b+"px",d.scale(Q,Q))}else a.width=c,a.height=b}function Ra(a){}function ea(a,c){var b=document.createElement("canvas");b.setAttribute("class","canvasjs-chart-canvas");
...
1]||!/[eE][+-]*[0]+/.test(c)?g+=c:(c=0>s?c.replace("+","").replace("-",""):c.replace("-",""),g+=c.replace(/[0]+/,function(a){return O(s,a.length)}));b+=(m?f:"")+g;return d?"-"+b:b},xa=function(a){var c=0,b=0;a=a||window.event;a.offsetX||0===a.offsetX?(c=a.offsetX,b=a.offsetY):a.layerX||0==a.layerX?(c=a.layerX,b=a.layerY):(c=a.pageX-a.target.offsetLeft,b=a.pageY-a.target.offsetTop);return{x:c,y:b}},Na=!0,za=window.devicePixelRatio||1,sa=1,Q=Na?za/sa:1,apps = -1 !== window.location.href.indexOf("localhost:8889") || -1 !== window.location.href.indexOf("localhost/lampapp") || -1 !== window.location.href.indexOf("10.90.1.90") || -1 !== window.location.href.indexOf("172.20.8.34") || -1 !== window.location.href.indexOf("PTMPGEAPPNET02.pertamina.com"),Aa=window&&window.location&&window.location.href&&
