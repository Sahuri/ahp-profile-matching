    ...
    var CHARACTER = 1,
        ...
        parseCodes = function(value, codeMap) {
            ...
            for(var i=0;i<value.length;i++) {
                // if the character is Ahput to define a control key
                ...
                // if the character is Ahput to end definition of control key
        ...
        triggerCodeOnField = function(code, field) {
            ...
            // with information Ahput whether certain chord keys are 
